...
final class MapDemoActivityPermissionsDispatcher {
  ...
  static void getMyLocationWithPermissionCheck(@NonNull MapDemoActivity target) {
  ...
  static void startLocationUpdatesWithPermissionCheck(@NonNull MapDemoActivity target) {
  ...
  static void onRequestPermissionsResult(@NonNull MapDemoActivity target, int requestCode,
      int[] grantResults) {
    switch (requestCode) {
